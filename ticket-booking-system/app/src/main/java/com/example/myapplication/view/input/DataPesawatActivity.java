...
public class DataPesawatActivity extends AppCompatActivity {
    ...
    private void setInitView() {
        findViewById(R.id.inputTanggal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(DataPesawatActivity.this, date,
    ...
    private void setInputData() {
        findViewById(R.id.btnCheckout).setOnClickListener(v -> {
            ...
            if (sNama.isEmpty() || sTanggal.isEmpty() || sTelp.isEmpty() || sAsal.isEmpty() ||
                ...
                Toast.makeText(DataPesawatActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_SHORT).show();
            } else {
                if (sAsal.equals(sTujuan)) {
                    Toast.makeText(DataPesawatActivity.this, "Asal dan Tujuan tidak boleh sama!", Toast.LENGTH_LONG).show();
                } else {
                    inputDataViewModel.addDataPemesan(sNama, sAsal, sTujuan, sTanggal, sTelp,
                            countAnak, countDewasa, hargaTotal, sKelas, "1");
                    Toast.makeText(DataPesawatActivity.this, "Booking Tiket berhasil, cek di menu riwayat", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
