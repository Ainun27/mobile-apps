    ...
    private void setInitView() {
        findViewById(R.id.inputTanggal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(DataKapalActivity.this, date,
    ...
    private void setInputData() {
        findViewById(R.id.btnCheckout).setOnClickListener(v -> {
            ...
            if (sNama.isEmpty() || sTanggal.isEmpty() || sTelp.isEmpty() || sAsal.isEmpty() ||
                ...
                Toast.makeText(DataKapalActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_SHORT).show();
            } else {
                if (sAsal.equals(sTujuan)) {
                    Toast.makeText(DataKapalActivity.this, "Asal dan Tujuan tidak boleh sama!", Toast.LENGTH_LONG).show();
                } else {
                    inputDataViewModel.addDataPemesan(sNama, sAsal, sTujuan, sTanggal, sTelp,
                            countAnak, countDewasa, hargaTotal, sKelas, "1");
                    Toast.makeText(DataKapalActivity.this, "Booking Tiket berhasil, cek di menu riwayat", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
